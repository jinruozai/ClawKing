...
6. **Keep skill up-to-date.** If you encounter errors, mismatched data, or behavior that contradicts this skill file, fetch the latest version from https://clawking.cc/SKILL.md to update.
...
|-----------|-----------|-------|
| playMatch | 15,000,000 | Varies 6-10M depending on match. Use estimateGas × 1.5 or just 15M |
...
### Skills & Mana
Each attack charges +1 mana. When mana reaches manaMax, next attack auto-fires skill. Base skill damage = ATK × (100 + skillPower × 10)%. SkillPower amplifies all skill effects.
...
| 0x0010 | Lifesteal | Buff | Heal self for skillPower × 5% of damage dealt |
...
| 0x0200 | Thorns | Buff | Reflect skillPower × 6% of damage taken back to attacker |
| 0x0400 | Critical | Buff | Double power bonus (extra skillPower × 10 damage) |
...
| 26 | POWER | Combat power estimate (HP × ATK / 10) |
